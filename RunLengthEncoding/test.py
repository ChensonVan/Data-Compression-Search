...
tests.extend([
    Case('single', './testfiles', 'single.debug.txt', 'single.txt'),
    Case('double', './testfiles', 'double.debug.txt', 'double.txt'),
    Case('double_a', './testfiles', 'double_a.debug.txt', 'double_a.txt'),
    Case('abcdefg', './testfiles', 'abcdefg.debug.txt', 'abcdefg.txt'),
    Case('hello', './testfiles', 'hello.debug.txt', 'hello.txt'),
